...
class FirebaseAPI {
  ...
  Future<QuerySnapshot> getProductOrders(String userID) async {
    CollectionReference ref = firestoreInstance.collection('users');
    QuerySnapshot eventsQuery =
        await ref.doc(userID).collection("orders").get();
    return eventsQuery;
  }
  ...
  Future<QuerySnapshot> getUserWithToken(String token) async {
    CollectionReference ref = firestoreInstance.collection('users');
    QuerySnapshot eventsQuery =
        await ref.where("documentReference", isEqualTo: token.trim()).get();
